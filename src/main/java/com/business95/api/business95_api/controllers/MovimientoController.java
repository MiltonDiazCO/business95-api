...
public class MovimientoController {
    ...
    public MovimientoResponseDTO movimientoPorId(@PathVariable Long idMovimiento) {
    ...
    public ResponseEntity<?> registrarActividad(
            ...
            @Valid @RequestBody List<ActividadSocioRequestDTO> actividadesSocioRequestDTOs, BindingResult result,
