...
public class MovimientoPorInversionConsultaDTO {
    ...
    public MovimientoPorInversionConsultaDTO() {
    }

    public MovimientoPorInversionConsultaDTO(Long idMovimiento, String categoria, String concepto, BigDecimal cantidad,
